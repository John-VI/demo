...
{
    if (warp)
        outColor = texture(tex, vec2(fragtexcoord.x, sin(fragtexcoord.y * time / 100))) * fragcolor;
    else
...
/*    trans = glm::scale(glm::mat4(1.0), glm::vec3(11, 11, 11));
    ...
    */
    ...
    //trans = glm::translate(glm::mat4(1.0), glm::vec3(INTWID / 2, INTHEI / 2, -1));
    trans = glm::scale(glm::mat4(1.0), glm::vec3(3, 3, 3));
    trans = glm::rotate(trans, elapsedtime * 0.001f, glm::vec3(0, 1, 0));
    glUniformMatrix4fv(unimodel, 1, GL_FALSE, glm::value_ptr(trans));
    //glUniformMatrix4fv(uniproj, 1, GL_FALSE, glm::value_ptr(ortproj));
